package com.kotori.smarthome.constant;


//Constant.java     常量类，将常量全部写在该类中
public class Constant {
  public static int SCREENWIDTH=320;  //屏幕宽（本程序为横屏）
  public static int SCREENHEIGHT=240;     //屏幕高
  public static int PICWIDTH=320;          //图片宽度
  public static int PICHEIGHT=240;         //图片高度
